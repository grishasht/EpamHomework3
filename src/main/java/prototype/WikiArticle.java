...
public class WikiArticle implements Article {
    private String elvisArticle = "src/main/java/prototype/articles/elvis.txt";
    private String teslaArticle = "src/main/java/prototype/articles/tesla.txt";
    private String intelArticle = "src/main/java/prototype/articles/intel.txt";
    ...
    public void redactArticle(String article) throws IOException, NoSuchFieldException {
        String filePath = "src/main/java/prototype/articles/";
        String fileName;
